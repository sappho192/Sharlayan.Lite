namespace Sharlayan.Models.Resources {
    ...
    internal sealed class HermesResources {
        ...
        [JsonExtensionData] public IDictionary<string, JToken> OptionalResources { get; set; }
    }
    ...
    internal sealed class HermesUtf8StringLayout {
        ...
        [JsonProperty("stringLengthOffset", Required = Required.Always)] public int StringLengthOffset { get; set; }
    }
